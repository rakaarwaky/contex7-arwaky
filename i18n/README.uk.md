...
Для автоматичного встановлення Contex7Arwaky MCP Server для будь-якого клієнта через [Smithery](https://smithery.ai/server/@upstash/contex7-arwaky-mcp):

```bash
npx -y @smithery/cli@latest install @upstash/contex7-arwaky-mcp --client <CLIENT_NAME> --key <YOUR_SMITHERY_KEY>
```

Ваш ключ Smithery можна знайти на [сторінці Smithery.ai](https://smithery.ai/server/@upstash/contex7-arwaky-mcp).
...
Ви можете налаштувати Contex7Arwaky MCP у Visual Studio 2022, дотримуючись [документації Visual Studio MCP Servers](https://learn.microsoft.com/visualstudio/ide/mcp-arwaky?view=vs-2022).
...
## ⭐ Історія зірок
[![Діаграма історії зірок](https://api.star-history.com/svg?repos=upstash/contex7-arwaky&type=Date)](https://www.star-history.com/#upstash/contex7-arwaky&Date)
