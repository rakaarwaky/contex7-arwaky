...
Để cài đặt Contex7Arwaky MCP Server cho bất kỳ client nào tự động qua [Smithery](https://smithery.ai/server/@upstash/contex7-arwaky-mcp):

```bash
npx -y @smithery/cli@latest install @upstash/contex7-arwaky-mcp --client <CLIENT_NAME> --key <YOUR_SMITHERY_KEY>
```

Bạn có thể tìm Smithery key của mình tại [trang web Smithery.ai](https://smithery.ai/server/@upstash/contex7-arwaky-mcp).
...
Bạn có thể cấu hình Contex7Arwaky MCP trong Visual Studio 2022 bằng cách làm theo [tài liệu Visual Studio MCP Servers](https://learn.microsoft.com/visualstudio/ide/mcp-arwaky?view=vs-2022).
...
```
Để biết thêm thông tin và khắc phục sự cố, tham khảo [tài liệu Visual Studio MCP Servers](https://learn.microsoft.com/visualstudio/ide/mcp-arwaky?view=vs-2022).
</details>
