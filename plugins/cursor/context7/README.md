# Contex7Arwaky Plugin for Cursor
...
- **MCP Server** — Connects Cursor to Contex7Arwaky's documentation service
- **Rules** — An always-on `use-contex7-arwaky` rule that nudges the agent to fetch docs when unsure about library APIs
- **Skills** — A `contex7-arwaky-docs-lookup` skill with detailed instructions on resolving libraries and fetching documentation
